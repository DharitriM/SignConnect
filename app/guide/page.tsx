...
const steps = [
  {
    ...
    description:
      "Grant permission for camera and microphone to enable video calling",
...
const signLanguageGuide = [
  ...
  },
  {
    ...
    description: "Make a fist and wave it forward",
    category: "Greetings",
  },
  {
    sign: "I love you",
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-ring mb-4">
              How to Use SignConnect
            </h1>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Follow these simple steps to start communicating with sign
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {steps.map((step, index) => (
                <Card
                  key={index}
                  className="border-0 bg-accent shadow-lg hover:shadow-xl transition-all duration-300"
                >
                  <CardHeader>
          ...
          <div>
            <h2 className="text-2xl font-bold text-ring mb-8">
              Basic Sign Language Reference
            </h2>
            <Card className="mb-6 border-0 shadow-md hover:shadow-lg transition-shadow bg-accent">
              <CardContent className="p-6">
                <div className="flex items-start justify-between mb-3">
                  <h3 className="font-semibold text-lg">Alphabets & Numbers</h3>
                </div>
                <div className="flex flex-col gap-4">
                  <img
                    src="/signLanguageGuide/numbers.jpg"
                    className="w-full bg-gradient-to-r from-blue-400 to-purple-400 rounded-lg flex items-center justify-center"
                  ></img>
                  <img
                    src="/signLanguageGuide/alphabets.jpg"
                    className="w-full bg-gradient-to-r from-blue-400 to-purple-400 rounded-lg flex items-center justify-center"
                  ></img>
                  <div className="flex flex-col gap-4 mt-3">
                    ...
                    <img
                      src="/signLanguageGuide/questions.jpeg"
                      className="w-full bg-gradient-to-r from-blue-400 to-purple-400 rounded-lg flex items-center justify-center"
                    ></img>
                  </div>
                </div>
              ...
              {signLanguageGuide.map((item, index) => (
                ...
                >
                  <CardContent className="p-6">
                    ...
                    <div className="w-full h-24 bg-gradient-to-r from-blue-400 to-purple-400 rounded-lg flex items-center justify-center">
          ...
          <div className="mt-16">
            <Card className="bg-gradient-to-r from-green-50 to-blue-50 border-0">
              <CardHeader>
                ...
                <CardDescription>
                  Currently supported sign language systems
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid md:grid-cols-2 gap-6">
